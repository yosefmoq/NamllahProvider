...
import com.app.namllahprovider.databinding.ItemBillsBinding
...
class BillsAdapter(var context: Context, var list: ArrayList<BillDto>) :
    ...
    class BillsViewHolder(var itemBillsImageBinding: ItemBillsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BillsViewHolder = BillsViewHolder(
        ItemBillsBinding.inflate(LayoutInflater.from(parent.context),parent,false))
